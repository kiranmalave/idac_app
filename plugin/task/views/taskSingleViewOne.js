define([
    ...
    var taskSingleViewOne= Backbone.View.extend({
      ...
      initialize: function (options) {
        ...
        this.toClose = "taskSingleViewOne";
        this.tagID = null;
        var selfobj = this;
      ...
      loadSubView: function (e) {
        ...
        switch (show) {
          case "taskData": {
            ...
            new taskSingleViewOne({ task_id: task_id, scanDetails: this.scanDetails });
            break;
          }
      ...
      render: function () {
        ...
        if (Array.isArray(attachment_file)) {
          for (const fName of attachment_file) {
            const ftext = fName.split(".");
            let modifiedFName = fName; // Create a new variable to store the modified file name
            if (ftext[2] === "xls" || ftext[2] === "xlsx") {
            ...
            console.log(modifiedFName);
            docUrl += "<div class='col-xl-2 col-lg-3 col-md-4 col-sm-12 m-b-20' data-show='singleFile' data-url='" + UPLOADS + "/" + modifiedFName + "'><div class='thumbnail'><div class='centered'><img class='img-fluid fileImage img-thumbnail' src='" + UPLOADS + "/" + modifiedFName + "' alt=''></div></div></div>";
          }
          document.getElementById("attachedDoc").innerHTML += docUrl;
        }
        return this;
