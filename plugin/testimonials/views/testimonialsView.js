...
], function($,_, Backbone,datepickerBT,testimonialsSingleView,testimonialsCollection,testimonialsFilterOptionModel,testimonialsRowTemp,testimonialsTemp,testimonialsFilterTemp){
...
var testimonialsView = Backbone.View.extend({
    ...
    initialize: function(options){
      this.toClose = "testimonialsFilterView";
        ...
        readyState = true;
        this.render();
        filterOption = new testimonialsFilterOptionModel();
        searchtestimonials = new testimonialsCollection();
        searchtestimonials.fetch({headers: {
      ...
      this.collection = searchtestimonials;
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singleTestimonialsData":{
            ...
            new testimonialsSingleView({testimonial_id:testimonial_id,searchtestimonials:this});
            break;
          }
        }
    },
    resetSearch: function(){
      filterOption.set({ curpage: 0, testimonial_id: null, textval: null, textSearch: 'testimonial_id', status: 'active', orderBy: 'testimonial_name', order: 'ASC' });
        $(".multiOptionSel").removeClass("active");
        $("#textval").val("");
        $('#textSearch option[value=testimonial_id]').attr('selected','selected');
        this.filterSearch();
    },
    loaduser:function(){
    ...
    addOne: function(objectModel){
        ...
        $("#testimonialsList").append(template({testimonialsDetails:objectModel}));
    },
    addAll: function(){
    ...
    filterRender:function(e){
      ...
      if(!isexits){
        var source = testimonialsFilterTemp;
        ...
        */
        ...
        /* 
          INFO
          make current testimonials active
        */
