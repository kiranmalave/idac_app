...
define([
...
], function ($, _, Backbone, datepickerBT, dynamicFromSingleView, dynamicFormsCollection, dynamicFormsFilterOptionModel, dynamicFormsRow, dynamicFormTemp, dynamicFormFilterTemp) {
  ...
  var dynamicFormsView = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      searchteam = new dynamicFormsCollection();
    ...
    loadSubView: function (e) {
      ...
      switch (show) {
        case "singleformData": {
          ...
          new dynamicFromSingleView({ form_id: form_id, searchform: this });
          break;
        }
      }
    },
    ...
    addOne: function (objectModel) {
      ...
      $("#formList").append(template({ formDetails: objectModel }));
    },
    addAll: function () {
      $("#formList").empty();
