define([
  ...
  'text!../templates/addQuestionFormRow.html',
], function ($, _, Backbone, validate, inputmask, datepickerBT,multiselectOptions,dynamicFieldRender,dynamicFormsCollection, dynamicFormsSingleModel,readFilesView,dynamicformtemp,QuestionRow_Temp,addQuestionFormRow_Temp) {
  ...
  var questionsFormsSingleView = Backbone.View.extend({
    ...
    textdescribe:function(){
      ...
      var editor1 = new Quill("#quill-editor-container", {
          modules: {
      ...
      var inputField = $("#quetions");
      var quillEditorContainer = $("#quill-editor-container");
