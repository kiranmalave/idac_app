...
], function ($, _, Backbone, validate, inputmask, datepickerBT, typeahead, icheck, select2, moment, multiselectOptions, customerCollection, singleTaxInvoiceModel, dynamicFieldRender, invoiceItems, taxInvoice_temp,customerSingleView) {
