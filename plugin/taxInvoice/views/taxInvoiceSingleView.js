...
var taxInvoiceSingleView = Backbone.View.extend({
    ...
    initialize: function(options){
      ...
      this.toClose = "taxinvoiceSingleView";
       ...
       // var companyList = new companyCollection();
        ...
        this.customerList.fetch({headers:
    ...
    addemptyRow:function(e){
      ...
      sel = sel + '<option value="'+val.invoiceChargeID+'">'+val.invoiceChargeName+'</option>';});sel = sel+'</select>';
    ...
    saveTaxInvoiceDetails: function(e){
      ...
      var customerID = selfobj.model.get("customerID");
      ...
      invoiceItemsDetails.sync(method,invoiceItemsDetails,{headers:{
