...
define([
...
], function ($, _, Backbone,moment,Swal,emailMasterSingleView, emailMasterCollection, emailMasterFilterOptionModel,configureColumnsView,appSettings,dynamicFormData,singleMenuModel,slugCollection,emailMasterRowTemp, emailMasterTemp, emailMasterFilterTemp,linkedDropdown) {
  ...
  var emailMasterView = Backbone.View.extend({
    ...
    loadSubView: function (e) {
      ...
      switch (show) {
        case "singleemailMasterData": {
          ...
          var emailMasterSingleview = new emailMasterSingleView({ tempID: tempID, searchemailMaster: this,menuId:selfobj.menuId,form_label:selfobj.form_label});
          break;
        }
      }
    ...
    filterRender: function (e) {
      ...
      var selfobj = this;
      if (!isexits) {
        var source = emailMasterFilterTemp;
    ...
    render: function () {
      ...
      var defaultWidth = numColumns == 0 ? '100%' : 100+(numColumns * 20) + '%';
