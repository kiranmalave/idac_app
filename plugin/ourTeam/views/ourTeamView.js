...
define([
...
], function ($, _, Backbone, datepickerBT, ourTeamSingleView, ourTeamCollection, ourTeamFilterOptionModel, ourTeamRowTemp, ourTeamTemp, ourTeamFilterTemp) {
  ...
  var ourTeamView = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      readyState = true;
      this.render();
      filterOption = new ourTeamFilterOptionModel();
      searchteam = new ourTeamCollection();
      searchteam.fetch({headers: {
    ...
    loadSubView: function (e) {
      ...
      switch (show) {
        case "singleteamData": {
          ...
          new ourTeamSingleView({ team_id: team_id, searchteam: this });
          break;
        }
      }
    },
    resetSearch: function () {
      filterOption.set({ curpage: 0, team_id: null, textval: null, textSearch: 'team_id', status: 'active', orderBy: 'name', order: 'ASC' });
      $(".multiOptionSel").removeClass("active");
      $("#textval").val("");
      $('#textSearch option[value=team_id]').attr('selected', 'selected');
      this.filterSearch();
    },
    loaduser: function () {
    ...
    addOne: function (objectModel) {
      ...
      $("#teamList").append(template({ teamDetails: objectModel }));
    },
    addAll: function () {
      $("#teamList").empty();
