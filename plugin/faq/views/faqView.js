...
], function($,_, Backbone,faqSingleView,faqCollection,faqFilterOptionModel,faqRowTemp,faqTemp,faqFilterTemp){
 ...
 var faqView = Backbone.View.extend({
    ...
    initialize: function(options){
      this.toClose = "faqFilterView";
        ...
        readyState = true;
        this.render();
        filterOption = new faqFilterOptionModel();
        searchfaq = new faqCollection();
        searchfaq.fetch({headers: {
        ...
        switch(show)
        {
          case "singlefaqData":{
            let faq_id = $(e.currentTarget).attr("data-faq_id");
             new faqSingleView({faq_id:faq_id,searchfaq:this});
            break;
          }
        }
    },
    resetSearch: function()
    {
        ...
        $("#textval").val("");
        $('#textSearch option[value=faq_id]').attr('selected','selected');
    ...
    addOne: function(objectModel){
        ...
        $("#faqList").append(template({faqDetails:objectModel}));
    },
    addAll: function(){
        $("#faqList").empty();
