...
define([
  ...
  var contactUsView = Backbone.View.extend({
    ...
    resetSearch: function () {
      filterOption.set({ curpage: 0, contactUsID: null, textval: null, textSearch: 'contactUsID', status: 'active', orderBy: 'client_name', order: 'ASC' });
      $(".multiOptionSel").removeClass("active");
      $("#textval").val("");
      $('#textSearch option[value=contactUsID]').attr('selected', 'selected');
      this.filterSearch();
    },
    loaduser: function () {
    ...
    addOne: function (objectModel) {
      ...
      $("#contactUsList").append(template({ contactUsListDetails: objectModel }));
    },
    addAll: function () {
      $("#contactUsList").empty();
