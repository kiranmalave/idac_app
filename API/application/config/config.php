...
$config['base_url'] = 'http://localhost/projects/idac_app-1/API/';
$config['app_url'] = 'http://localhost/projects/idac_app-1/';
$config['appName'] = 'IDAC_App';
$config['imagesPATH'] = $_SERVER['DOCUMENT_ROOT'].'/idac_app-1/images/';
$config['mediaPATH'] = $_SERVER['DOCUMENT_ROOT'].'/idac_app-1/uploads/';
$config['mediaPATH'] = $_SERVER['DOCUMENT_ROOT'].'/projects/idac_app-1/website/uploads/';
