...
class EmailMaster extends CI_Controller
{
	...
	public function getEmailDetailsList()
	{
		...
		$config["total_rows"] = $this->CommonModel->getCountByParameter('tempID', "email_master", $wherec);
		...
		if ($isAll == "Y") {
			$pagesDetails = $this->CommonModel->GetMasterListDetails($selectC="tempID",'email_master',$wherec,'','',$join,$other);	
		}else{
